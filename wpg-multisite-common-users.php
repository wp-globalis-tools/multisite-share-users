...
function msu_add_to_all_sites( $user_id, $password='', $meta='' )  {
	...
	$sites = wp_get_sites(['limit' => MSU_MAX_SITES]);
...
add_action( 'wpmu_new_user', __NAMESPACE__ . '\\msu_add_to_all_sites', 10, 1 );

// When admin of a subsite creates it
add_action( 'wpmu_activate_user', __NAMESPACE__ . '\\msu_add_to_all_sites', 10, 3 );
